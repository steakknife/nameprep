...
require 'nameprep/version'

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = 'nameprep'
  s.version     = Nameprep::VERSION
  s.authors     = ['Barry Allard']
  s.email       = ['barry.allard@gmail.com']
  s.homepage    = 'https://github.com/steakknife/nameprep'
  s.summary     = 'Stringprep'
  s.description = 'Pure Ruby Nameprep implementation (RFC 3491)'
  s.license     = 'MIT'
